      ...
      <div className="contact-text-overlay">
        <div className="contact-section">
          <h3 className="contact-title">{t('contactPage.title')}</h3>
            <FaHome className="card-icon1"/><p className="contact-info">{t('contactPage.address')}</p>
            <FaLocationArrow className="card-icon1"/><p className="contact-info">{t('contactPage.service')}</p>
            <HiOutlineMail className="card-icon1"/><p className="contact-info">{t('contactPage.email')}</p>
            <FaPhone className="card-icon1"/><p className="contact-info">{t('contactPage.phone')}</p>
        </div>
